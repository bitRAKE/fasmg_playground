...
include './.win64/equates/winnt.inc'
...
13,10,	"It is designed to consume all available memory.",\
13,10,\
13,10,	"IT WILL GREATLY IMPACT SYSTEM PERFORMANCE!",\
13,10,\
...
.not_any_thread:
	...
	xor ebx,ebx
	call KERNEL32:VirtualQuery,rbx,ADDR mbi,sizeof mbi
	xchg rcx,rax
	jrcxz .vq_error

	; try to allocate any MEM_FREE range of size less than free memory
